...
public class PluginCore {
	...
	public void addManager(PluginManager m)
	{
		manager = m; 
	}
	public void stop() {
	...
	private void addAddActionListener()
	{
		addButton.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				int val = choice.showOpenDialog(addButton); 
				File file = choice.getSelectedFile(); 
				try 
				{
					manager.loadBundle(file.toPath());
				} 
				catch (Exception e1) 
				{
